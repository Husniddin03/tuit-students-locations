    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Barcha talabalar</h1>
            </div>

            <form method="GET" class="w-full mx-3 border-radius-2">
                <input id="modal-search" style="border-radius: 7px" name="search"
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                <a href="{{ request()->fullUrlWithQuery(['download' => 'search']) }}"
                    ...
                    <span class="max-xs:sr-only">Yuklash</span>
                </a>
                        ...
                        <table class="table-auto w-full dark:text-gray-300">
                            ...
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th class="p-2">
                                        <div class="font-semibold text-center">Fakultet</div>
                                    </th>
                                    <th class="p-2">
                                        <div class="font-semibold text-center">Guruh</div>
                                    </th>
                                    <th class="p-2">
                                        <div class="font-semibold text-center">Murabbiy</div>
                                    </th>
                                    <th class="p-2">
                                        <div class="font-semibold text-center">Turar joy</div>
                                    </th>
                                </tr>
                            </thead>
                            <!-- Table body -->
                            <tbody class="text-sm font-medium divide-y divide-gray-100 dark:divide-gray-700/60">
                                ...
                                @foreach ($students as $student)
                                    <tr>
                                        <td class="p-2">
                                            <div class="flex items-center">
                                                <img style="border-radius: 50%; width: 3rem; height: 3rem;"
                                                    src="https://ui-avatars.com/api/?name={{ $student->first_name ?? '' }}
                                        {{ $student->last_name ?? '' }} {{ $student->middle_name ?? '' }}&background=random&size=64"
                                                    alt="Icon" />

                                                <a href="{{ route('students.show', $student->id) }}"
                                                    class="text-gray-800 dark:text-gray-100 mx-2">{{ $student->first_name ?? '' }}
                                                    {{ $student->last_name ?? '' }}
                                        ...
                                        <td class="p-2">
                                            <div class="text-center">{{ $student->faculty }}</div>
                                        </td>
                                        <td class="p-2">
                                            <div class="text-center text-green-500">{{ $student->group }}</div>
                                        </td>
                                        <td class="p-2">
                                            <div class="text-center">{{ $student->coach }}</div>
                                        </td>
                                        <td class="p-2">
